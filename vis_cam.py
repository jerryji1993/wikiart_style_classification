...
#     original_img = cv2.merge([r,g,b])     # switch it to r, g, b
...
def get_args():
    ...
    parser.add_argument("--model_path", type = str, default = "./inception_resnet_300vis.h5", help = "Path of the trained (and converted) model")
    ...
    parser.add_argument("--conv_layer_name", type = str, default = 'conv_7b', help = 'Name of last convolutional layer?')
